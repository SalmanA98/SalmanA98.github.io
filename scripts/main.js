    ...
    data() {
      return {
        ...
        skillsItems: [{
          ...
          imgUrl: '/assets/images/skills/css-3.png',
          title: 'CSS3'
        }, {
          imgUrl: '/assets/images/skills/javascript.png',
          title: 'JavaScript'
        }, {
          imgUrl: '/assets/images/skills/dotnet.png',
          title: '.NET'
        }, {
        ...
        toolsItems: [{
          ...
          imgUrl: '/assets/images/skills/pixlr.png',
          title: 'Pixlr'
        }],
        ...
        experienceItems: [{
          ...
          desc: {
            en: 'Built high-speed mobile powered solution that caters to all the solutions needed for sales and inventory management.',
            ar: 'تم إنشاء حل عالي السرعة يعمل بالطاقة المتنقلة يلبي جميع الحلول اللازمة لإدارة المبيعات والمخزون'
          }
        }, {
          date: '2021',
          companyName: {
          ...
          jobTitle: {
            en: 'Junior Developer and L&D Consultant',
            ar: 'استشاري L&D مطور مبتدئ و'
          },
          desc: {
            en: 'Consulting software vendors such as Microsoft, Zoom, etc. and developing new features to integrate into the LMS',
            ar: 'LMS وتطوير ميزات جديدة لدمجها في Microsoft, Zoom استشارة بائعي البرامج مثل'
          }
        }, {
          date: '2022',
          companyName: {
            en: 'EFS Facilities Services Group',
            ar: 'مجموعة خدمات المرافق EFS'
          },
          jobTitle: {
          ...
          desc: {
            en: 'Developing solutions to automate processes used in FM Services (CAFM) using .NET, Jquery, CSS, HTML, MySQL, etc',
            ar: 'تطوير حلول لأتمتة العمليات المستخدمة في خدمات FM (CAFM) باستخدام .NET و Jquery و CSS و HTML و MySQL وما إلى ذلك'
          }
        }, {}, {}, {}],
        ...
        allPortfolioItems: [{
          ...
          imgUrl: 'assets/images/projects/inventory-management-app.png',
          title: {
          ...
          desc: {
            en: 'The inventory management app is a single solution system to cater all needs of the client. This was specifically made for a client with a huge perfume chain. It handles all the sales, invoicing and so on. It contains a refund system which makes use of each unique sale ID. Furthermore, clients are able to view the sales data between any dates in excel format and maintain the complete inventory.',
            ar: 'تطبيق إدارة المخزون هو نظام حل واحد لتلبية جميع احتياجات العميل. تم صنع هذا خصيصًا لعميل لديه سلسلة عطور ضخمة. إنه يتعامل مع جميع المبيعات والفواتير وما إلى ذلك. يحتوي على نظام استرداد يستخدم كل معرّف بيع فريد. علاوة على ذلك ، يمكن للعملاء عرض بيانات المبيعات بين أي تواريخ بتنسيق Excel والحفاظ على المخزون الكامل'
          },
          category: 'Mobile App',
          tools: ['Flutter', 'Firebase'],
          screenshots: {
            img1: {
              url: 'assets/images/projects/inventory-management-app.png',
              caption: {
                en: 'caption 5',
                ar: 'تسمية توضيحية 5'
              }
          ...
          imgUrl: 'assets/images/projects/eventmanagement-2.0.png',
          title: {
            en: 'Event Management System 2.0',
          ...
          desc: {
            en: `A simple app build using Flutter that is integrated with a .NET Core API. Developed for an event management team to keep track of registration and food consumption. It communicates using the API to validate whether or not a user is registered or if the user has consumed food.
            It also provided a sophisticated raffle draw system built in .NET Core which picked random prizes and their random winners from a pool of 4000+ people.`,
            ar: 'إنشاء تطبيق بسيط باستخدام Flutter الذي يتكامل مع .NET Core API. تم تطويره لفريق إدارة الحدث لتتبع التسجيل واستهلاك الطعام. إنها تتصل باستخدام واجهة برمجة التطبيقات للتحقق مما إذا كان المستخدم مسجلاً أم لا أو إذا كان المستخدم قد تناول الطعام.'
          },
          category: '.NET and Flutter',
          tools: ['Flutter', '.NET', 'C#', 'HTML','SASS','JQuery','MySQL'],
          screenshots: {
            img1: {
          ...
          imgUrl: 'assets/images/projects/eventmanagement-1.0.png',
          title: {
            en: 'Event Management System using NodeJS',
          ...
          desc: {
            en: 'This system built specifically for event management provided the client with multiple functionalities to cater the whole event. It had a registration system, food and snack consumption tracking feature, games tracking feature and so on all based on QR code scanning. This was the first iteration of the raffle draw system.',
          ...
          category: 'NodeJS',
          tools: ['NodeJS','HTML', 'EJS', 'CSS', 'ExpressJS', 'JavaScript', 'MySQL', 'AJAX'],
          screenshots: {
            img1: {
              url: 'https://via.placeholder.com/355x200',
              caption: {
